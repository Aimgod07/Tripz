    ...
    <>
      ...
      <div className="relative min-h-screen py-20 bg-gradient-to-br from-gray-900 via-slate-900 to-gray-900 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          {" "}
          <div className="absolute -top-40 -left-40 w-96 h-96 bg-gray-400/20 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16">
            {" "}
            <div className="inline-flex items-center px-4 py-2 bg-gray-500/20 backdrop-blur-sm rounded-full mb-6 border border-gray-300/30">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              overwhelming, especially when it comes to securing the necessary
              documentation. Founded in 2020 by a team of travel enthusiasts and
              industry experts, our mission is to simplify this process and make
              travel dreams a reality for everyone.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-gray-300 text-lg leading-relaxed mb-6">
                To simplify the travel documentation process by providing
                genuine, verifiable documents that meet embassy and consulate
                requirements worldwide. We believe everyone deserves hassle-free
                travel planning.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <span className="text-gray-300">
                    Create Your Dream Trip According to Your Budget
                  </span>
                </div>
                <div className="flex items-center space-x-3">
                  <div className="w-6 h-6 bg-gray-500 rounded-full flex items-center justify-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-gray-300 text-center leading-relaxed">
                  ...
                  bank-level security measures and strict confidentiality
                  protocols.
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-gray-300 text-center leading-relaxed">
                  Quick turnaround times without compromising quality. Most
                  documents delivered within an hour of confirmation.
                </p>
              </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-6 border border-white/20 text-center group hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-gray-300 text-sm">
                  10+ years in travel industry with expertise in visa
                  requirements
                </p>
              </div>
