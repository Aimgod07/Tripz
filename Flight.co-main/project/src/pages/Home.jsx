                ...
                <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    ...
                    <section className="py-16 transform transition-all duration-700 hover:scale-[1.02]">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                                Get authentic dummy tickets and hotel reservations for your visa applications
                            </p>
                        </div>
                        <Dummyticket />
                    ...
                    <section className="py-16 border-t border-gray-200">
                        <div className="text-center">
                            ...
                            </h3>                            <div className="grid grid-cols-2 md:grid-cols-4 gap-8 items-center opacity-60">
                                <div className="flex flex-col items-center">
                                    <div className="text-3xl font-bold text-gray-600 mb-2">10K+</div>
                                    <div className="text-sm text-gray-600">Happy Customers</div>
                                </div>
                                <div className="flex flex-col items-center">
                                    <div className="text-3xl font-bold text-slate-600 mb-2">99%</div>
