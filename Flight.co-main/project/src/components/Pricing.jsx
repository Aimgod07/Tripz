        ...
        <>
            ...
            <div className="relative py-20 bg-gradient-to-br from-slate-50 via-gray-50 to-slate-50 overflow-hidden">
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {/* Header Section */}
                    <div className="text-center mb-16">                        <div className="inline-flex items-center px-4 py-2 bg-gray-100 rounded-full mb-6">
                        ...
                        <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                            Get verified documents for your visa applications with guaranteed approval rates. 
                            Fast delivery and worldwide acceptance.
                        </p>
                    </div>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <div className="group relative">
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 transform transition-all duration-700 hover:scale-105 hover:shadow-3xl h-full">
                                ...
                                {/* Icon */}
                                <div className="flex justify-center mb-6 mt-4">                                    <div className="relative">
                                        <img src="../assets/flt.png" alt="Flight ticket" className="w-20 h-20 object-contain transform group-hover:scale-110 transition-transform duration-500"/>
                                ...
                                {/* Features */}                                <div className="space-y-3 mb-8">
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                        </div>
                                        <span className="text-gray-600 text-sm">Verified flight reservation</span>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                        </div>
                                        <span className="text-gray-600 text-sm">Maximum of two flights permitted</span>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                        </div>
                                        <span className="text-gray-600 text-sm">Valid for 1-2 weeks (depends on route)</span>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                        </div>
                                        <span className="text-gray-600 text-sm">Quick delivery in 30-60 minutes</span>
                                    </div>
                                </div>

                                {/* CTA Button */}
                                <div className="text-center mt-auto">                                    <a href="/ticketform" className="block">
                            ...
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 transform transition-all duration-700 hover:scale-105 hover:shadow-3xl h-full">
                                ...
                                <div className="flex justify-center mb-6 mt-8">
                                    <div className="relative">
                                        <img src="../assets/hotel.png" alt="Hotel reservation" className="w-20 h-20 object-contain transform group-hover:scale-110 transition-transform duration-500"/>
                                        <div className="absolute -top-2 -right-2 w-6 h-6 bg-gray-500 rounded-full flex items-center justify-center animate-bounce">
                                            <span className="text-white text-xs">🏨</span>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-3 mb-8">
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <span className="text-gray-600 text-sm">Verified hotel reservation</span>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                        </div>
                                        <span className="text-gray-600 text-sm">Maximum of two hotel bookings</span>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                        </div>
                                        <span className="text-gray-600 text-sm">Valid until check-in date</span>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                ...
                                {/* CTA Button */}
                                <div className="text-center mt-auto">                                    <a href="/buynow" className="block">
                                        <button className="w-full bg-gradient-to-r from-gray-600 to-slate-600 text-white font-bold py-4 px-6 rounded-2xl shadow-lg transform transition-all duration-300 hover:scale-105 hover:shadow-xl hover:from-gray-700 hover:to-slate-700">
                                            Book Now
                                        </button>
                                    </a>
                        ...
                        <div className="group relative">
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 transform transition-all duration-700 hover:scale-105 hover:shadow-3xl h-full">
                                ...
                                <div className="flex justify-center mb-6 mt-8">
                                    <div className="relative">
                                        <img src="../assets/insurance.png" alt="Travel insurance" className="w-20 h-20 object-contain transform group-hover:scale-110 transition-transform duration-500"/>
                                        <div className="absolute -top-2 -right-2 w-6 h-6 bg-gray-500 rounded-full flex items-center justify-center animate-bounce">
                                ...
                                {/* Features */}                                <div className="space-y-3 mb-8">
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <span className="text-gray-600 text-sm">Provable insurance coverage</span>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                        </div>
                                        <span className="text-gray-600 text-sm">Maximum 2 changes allowed</span>
                                    </div>
                                    <div className="flex items-start space-x-3">
                                        <div className="w-5 h-5 bg-gray-500 rounded-full flex items-center justify-center mt-0.5">
                                            <span className="text-white text-xs">✓</span>
                                        </div>
                                        <span className="text-gray-600 text-sm">Beneficial for immigration & visa</span>
                    ...
                    <div className="mt-20 text-center">
                        <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/50">                            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                                <div className="transform transition-all duration-500 hover:scale-110">
                                    <div className="text-3xl font-bold text-slate-600 mb-2">99.8%</div>
                                    <div className="text-gray-600 text-sm">Success Rate</div>
                                </div>
                                <div className="transform transition-all duration-500 hover:scale-110">
                                    <div className="text-3xl font-bold text-gray-600 mb-2">30-60min</div>
                                    <div className="text-gray-600 text-sm">Delivery Time</div>
                                </div>
                                <div className="transform transition-all duration-500 hover:scale-110">
                                    <div className="text-3xl font-bold text-slate-700 mb-2">50K+</div>
