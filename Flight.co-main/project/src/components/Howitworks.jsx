                ...
                <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center px-4 py-2 bg-gray-100 rounded-full mb-6">
                            ...
                            <span className="text-gray-700 text-sm font-medium">Simple Process</span>
                        </div>
                    ...
                    <div className="grid lg:grid-cols-3 gap-8 lg:gap-12 relative">
                            ...
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 transform transition-all duration-700 hover:scale-105 hover:shadow-3xl">
                                ...
                                <div className="flex justify-center mb-6 mt-4">
                                    <div className="relative">
                                        <img src="../assets/form.png" alt="Fill form" className="w-20 h-20 object-contain transform group-hover:scale-110 transition-transform duration-500"/>
                                ...
                                <p className="text-gray-600 text-center leading-relaxed">
                                    ...
                                    desired travel dates, email address, and departure/arrival destinations.
                                </p>
                        ...
                        <div className="group relative">
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 transform transition-all duration-700 hover:scale-105 hover:shadow-3xl">
                                ...
                                <div className="flex justify-center mb-6 mt-4">
                                    <div className="relative">
                                        <img src="../assets/card.png" alt="Make payment" className="w-20 h-20 object-contain transform group-hover:scale-110 transition-transform duration-500"/>
                        ...
                        <div className="group relative">
                            <div className="relative bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 transform transition-all duration-700 hover:scale-105 hover:shadow-3xl">
                                ...
                                <div className="flex justify-center mb-6 mt-4">
                                    <div className="relative">
                                        <img src="../assets/open.png" alt="Get ticket" className="w-20 h-20 object-contain transform group-hover:scale-110 transition-transform duration-500"/>
                                ...
                                {/* Description */}
                                <p className="text-gray-600 text-center leading-relaxed">
                                    Your ticket will be sent as a PDF attachment via email within 60 minutes. 
                                    You can verify your dummy ticket on the airline's website.
                                </p>
