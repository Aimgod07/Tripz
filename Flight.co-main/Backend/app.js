...
app.post("/api/plan-trip", async (req, res) => {
 ...
 const prompt = `
Do not give any additional tip or notes just give info about flights ,hotels,restaurants,weathers ,places and Generated trip recommendations in JSON format:
{
